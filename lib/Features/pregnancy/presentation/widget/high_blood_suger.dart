        ...
        if (showField1)
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    PregnancyInformation(text: "Avoid high-fat foods"),
                    PregnancyInformation(
                        text: "Monitor blood suger level 4 \ntimes daily"),
                    PregnancyInformation(text: "Maintion a healthy weight"),
                    PregnancyInformation(
                        text:
                            "Detect fetal movement and \nheart beats periodically"),
                  ],
                ),
              ),
            ],
            ...
            children: [
             const  IfYes(),
              Container(
                ...
                child: Column(
                  children: [
                    PregnancyInformation(text: "Eat healthy food(fruits, \nvegetables,nuts)"),
                    PregnancyInformation(
                        text: "Monitor blood suger level 4 \ntimes daily"),
                    PregnancyInformation(text: "Maintion a healthy weight"),
                    PregnancyInformation(
        ...
        if (showField4)
            ...
            const   IfYes(),
              Container(
                ...
                child: Column(
                  children: [
                    PregnancyInformation(text: "Avoid psychological pressure"),
                                        PregnancyInformation(text: "Exercising regularly"),
                    PregnancyInformation(text: "Enough sleep"),
                ...
                child: Column(
                  children: [
                    ...
                    PregnancyInformation(
                        text:
                            "Detect fetal movement and \nheart beats periodically"),
                                      PregnancyInformation(text: "Adherence to the \nmedications recommended \nby the doctor"),
